...
// Constructor
//
CustomSoftwareSerial::CustomSoftwareSerial(uint8_t receivePin, uint8_t transmitPin, bool inverse_logic) :
  _rx_delay_centering(0),
  _rx_delay_intrabit(0),
  _rx_delay_stopbit(0),
  _tx_delay(0),
...
static CustomSoftwareSerial sSerial;
